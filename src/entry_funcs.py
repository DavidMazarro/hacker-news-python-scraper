...
def entries_gr5_comment_num(entries: list[Entry]) -> list[Entry]:
    """
    This function recieves a list of entries and returns the entries with
    more than five words in the title ordered by the number of comments from
...
def entries_leq5_points(entries: list[Entry]) -> list[Entry]:
    """
    This function recieves a list of entries and returns the entries with
    less than five or equal words in the title ordered by the number of comments
